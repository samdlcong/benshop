...
CREATE TABLE IF NOT EXISTS `shop_admin`(
    ...
    `logintime` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '登入时间',
    `loginip` BIGINT NOT NULL DEFAULT '0' COMMENT '登入时间',
...
INSERT INTO `shop_admin` (adminuser,adminpass,adminemail,createtime) VALUES ('admin',md5('123'),'admin@126.com',UNIX_TIMESTAMP());